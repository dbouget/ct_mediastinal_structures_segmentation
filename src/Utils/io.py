...
def dump_predictions(predictions, training_parameters, runtime_parameters, nib_volume, storage_prefix):
    print("Writing predictions to files...")
    naming_suffix = 'pred' if runtime_parameters.predictions_reconstruction_method == 'probabilities' else 'labels'
    class_names = training_parameters.training_class_names
